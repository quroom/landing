...
- **AND** service summaries make it easier to judge when the card fits, not only what the service category is called
...
- **AND** founder-facing summaries and subtitles use a consistent language level across Hero, service cards, and persona routes
