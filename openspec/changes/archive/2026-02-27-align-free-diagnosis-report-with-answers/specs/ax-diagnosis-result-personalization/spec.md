...
The system MUST provide personalized interpretation by combining each internal category with a category-specific A/B/C grade message, while ensuring primary guidance text is aligned to question intent language and free of unnecessary anchor disclosure.
