...
#### Scenario: Bridged contact submissions are measurable
- **WHEN** a user enters contact form from diagnosis CTA bridge
- **THEN** the resulting contact submission MUST be attributable to lead-magnet bridge context
- **AND** bridge-attributed contact submissions MUST be countable in conversion KPI calculations
