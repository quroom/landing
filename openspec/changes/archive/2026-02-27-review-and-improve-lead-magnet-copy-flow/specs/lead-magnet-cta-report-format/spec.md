...
- **THEN** the report MUST include a clear summary section written in action-oriented language
...
- **AND** the report MUST include a completion criterion sentence for that task
