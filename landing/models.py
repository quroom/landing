...
class ContactInquiry(models.Model):
    ...
    page_key = models.CharField(max_length=40, blank=True, null=True, default="")
    lead_source = models.CharField(max_length=80, blank=True, null=True, default="")
    ad_source = models.CharField(max_length=40, blank=True, null=True, default="")
