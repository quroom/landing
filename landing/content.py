...
EN_TRANSLATIONS = {
    ...
    "아이디어/운영 이슈를 빠르게 구조화하고 자동화 우선순위를 설계합니다.": "Quickly structure idea/operations issues and design automation priorities.",
    "현재 업무 흐름/병목 구간 진단": "Diagnose current workflow and bottlenecks",
    "OpenClaw/바이브코딩 적용 후보 도출": "Identify OpenClaw/vibe-coding application candidates",
    "2주 실행 백로그와 기준선 정의": "Define a 2-week execution backlog and baseline",
    "자동화 실행 진단 리포트 + 우선순위 백로그": "Automation diagnosis report + prioritized backlog",
    ...
    "바이브코딩/OpenClaw/자동화 조합으로 핵심 실행 체계를 구축합니다.": "Build a core execution system with vibe coding, OpenClaw, and automation.",
    "핵심 업무 플로우와 제품 실행 루프 설계/구현": "Design/implement core work flows and product execution loops",
    "OpenClaw/바이브코딩 기반 반복 작업 자동화 적용": "Apply repetitive task automation with OpenClaw/vibe coding",
    "운영 가이드와 인수인계 문서 제공": "Provide operation guides and handover documentation",
    "운영 가능한 자동화 실행 체계 + 운영 문서": "Operable automation execution system + operational documents",
    ...
    "핵심 제품/자동화 구축을 고밀도로 진행하는 전담 외주용역 트랙입니다.": "A dedicated outsourcing track for high-intensity core product and automation builds.",
    "요구사항 정밀 정의 및 주차별 마일스톤 수립": "Precisely define requirements and weekly milestones",
    "제품/자동화 구현 + 운영 이관까지 일괄 수행": "Deliver implementation plus operations handover",
    "범위 변경 시 영향도(일정/비용) 사전 합의": "Pre-agree schedule/cost impacts for scope changes",
    "운영 가능한 결과물 + 인수인계 문서 + 안정화 지원": "Operable deliverables + handover docs + stabilization support",
