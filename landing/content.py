...
SHARED_CONTENT = {
    "site_name": "큐룸",
    "seo_title": {
        "ko": "큐룸 | 웹·앱 외주 개발 & 린 MVP 개발사",
        "en": "QUROOM | Web & App Development Partner & Lean MVP Builder",
    },
    "seo_description": {
        "ko": "큐룸은 8년 차 삼성전자 출신 1인 풀스택 개발사입니다. 웹·앱 외주 개발, 린 MVP 구현, 실서버 배포 및 운영 이관까지 대표가 직접 책임집니다.",
    ...
    "engagements": [
        ...
        {
            "title": {
                "ko": "계약 전 5대 제외 기준 & 표준 견적서",
                "en": "5 Out-of-Scope Rules & Standard Quote Template",
            },
            "description": {
    ...
    "profile_lead": {
        "ko": "삼성전자에서 소프트웨어를 개발했고, 이후 8년 차 개발사 큐룸을 설립하여 직접 운영해왔습니다. 개발뿐 아니라 고객 응대, 비용, 현장 운영도 직접 해봤습니다.",
...
GWANGJU_PAGE_CONTENT = {
    "gwangju": {
        "meta_title": "광주 웹·앱 개발 외주 | MVP·업무 시스템 | 큐룸",
        "meta_description": "광주광역시 8년 차 1인 풀스택 개발사 큐룸. 웹서비스, 앱·PWA, 업무 시스템의 요구사항 정리부터 배포까지 대표가 직접 책임집니다.",
        "meta_keywords": "광주 웹개발, 광주 앱개발, 광주 MVP 개발, 광주 개발 외주, 광주 개발 파트너",
        "hero_label": "광주 개발 상담",
        "hero_title": "광주 웹·앱 개발 외주, 개발 범위와 견적 기준부터 명확히 세웁니다",
        "hero_summary": "웹서비스, 앱·PWA, 업무 시스템에 필요한 기능과 운영 조건을 먼저 확인하고 기획 정리부터 개발, 배포까지 한 사람이 이어서 맡습니다.",
        "hero_badges": [
            "광주 기반 상담",
            "범위·일정·운영 기준 합의",
            "대표자가 직접 진행",
    ...
    "gwangju_homepage": {
        "meta_title": "광주 홈페이지 제작 | 회사·서비스 소개와 문의 전환 | 큐룸",
        "meta_description": "광주 기업·회사 소개 홈페이지 제작. 방문자 문의 전환 구조를 큐룸 8년 차 개발사가 직접 기획·구축합니다.",
        ...
        "hero_summary": "광주 기업의 소개, 서비스 강점, 고객 문의 동선을 명확히 설계합니다. 광주 북구에 기반을 둔 8년 차 개발사가 기획부터 배포까지 직접 구축합니다.",
        ...
        "scope_items": [
            ...
            "서비스 소개/포트폴리오 페이지 구성",
            "문의 폼과 기본 전환 동선 구성",
            "Google·네이버 기본 메타데이터와 검색 노출 구조 적용",
            "배포 및 운영 기본 가이드 전달",
        ],
        "process_title": "진행 방식",
        "process_steps": [
        ...
        "faq": [
            {
                "q": "광주에서 대면 상담도 가능한가요?",
                "a": "가능합니다. 큐룸은 광주광역시 북구에 있으며, 일정과 장소를 협의해 대면 또는 온라인으로 상담합니다.",
            },
            {
    ...
    "gwangju_web_development": {
        "meta_title": "광주 웹개발 외주 | MVP·웹서비스·운영도구 구축 | 큐룸",
        "meta_description": "광주 웹개발 외주 파트너 큐룸. 린 MVP, 사내 관리자 도구, 업무 시스템을 8년 차 풀스택 엔지니어가 직접 만듭니다.",
    ...
    "gwangju_app_development": {
        "meta_title": "광주 앱개발 외주 | 웹앱·PWA·크로스플랫폼 기획과 구축 | 큐룸",
        "meta_description": "광주 모바일 앱·웹앱·PWA 개발 외주 파트너 큐룸. 사업 단계와 예산에 맞춘 최적의 개발 방식을 8년 차 개발사가 직접 제안하고 구축합니다.",
    ...
    "outsourcing_checklist": {
        "meta_title": "홈페이지·웹개발 외주 맡기기 전 체크리스트 7가지 | 큐룸",
        "meta_description": "홈페이지나 웹개발 외주를 맡기기 전에 범위, 일정, 비용, 유지관리, 소유권에서 꼭 확인해야 할 7가지 항목을 8년 차 개발사 큐룸이 정리했습니다.",
        ...
        "secondary_cta_label": "5대 제외 기준 보기",
        ...
        "wbs_rules": [
            {
                ...
                "rule": "본 계약의 개발 범위는 사전에 확정된 필수 핵심 기능(P0)으로 한정합니다.",
                "exclusions": [
                    "개발 진행 중 신규 화면 추가, 기존 확정된 비즈니스 로직 변경, 신규 사용자 권한 추가",
                    "계약 시 명시되지 않은 부가 기능(SNS 공유, 다크모드, 다국어 지원 등)",
                ],
            ...
            },
            {
                ...
                "procedure": "사전 확정된 필수 기능 명세대로 작동하지 않는 코드 버그는 무상 수정하며, 사용성 개선은 유상 별도 산정합니다.",
            },
            {
        ...
        "quote_template_title": "[실전 양식] 린 MVP 기능 명세서 및 표준 견적서 서식",
        "quote_template_intro": "8년 차 풀스택 엔지니어가 실제 사용하는 린 MVP 6대 모듈 기능 명세서와 국세청 전자세금계산서 표준 견적서 양식입니다. 아래 버튼으로 마크다운을 복사해 즉시 계약 별첨 자료로 활용하세요.",
        "quote_template_markdown": """# [프로젝트명] 린 MVP 외주 구축 기능 명세서 & 과업지시서
...
- 공급자: 큐룸 / 사업자등록번호: {company_biz_number}
...
| :--- | :--- | :---: | :---: | :---: |
| 린 MVP 풀스택 개발 | 1차 출시 핵심 6개 모듈 설계, 프론트/백엔드 구현 | 13 | M/D | 협의 |
