...
- 공급자: 쿼룸 (QUROOM) / 사업자등록번호: 729-16-01048
...
2. 검수 완료 후 3개월간 코드 오류에 대한 무상 하자보수를 보증합니다.""",
        ...
        "enaradaum_docs": [
            ...
            },
            {
                ...
                "name": "비교견적서 2부",
                "who": "주관기업+개발사",
                "point": "당사(쿼룸) 견적서 1부 + 타사 비교견적서 1부로 단가 및 공수 타당성 객관화",
            },
            {
                "num": "3",
                "name": "표준 과업지시서 & WBS",
...
- 수 급 인 (개발사): 쿼룸 (대표자: 김상은, 8년 차 풀스택 개발사)
