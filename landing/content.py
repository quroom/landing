...
EN_TRANSLATIONS = {
    ...
    "2025.08 ~ 현재": "2025.08 - Present",
    "2025.06 ~ 현재": "2025.06 - Present",
    "2025.04 ~ 현재": "2025.04 - Present",
    "2025.01 ~ 현재": "2025.01 - Present",
    "2026.03 ~ 2026.05": "2026.03 - 2026.05",
    "AI콜봇 NoMiss (getnomiss.com)": "AI Callbot NoMiss (getnomiss.com)",
    "광주 도서관 통합검색 (도서관포털)": "Gwangju Library Integrated Search (Library Portal)",
    "단어장앱 (아들 영단어 암기장)": "Vocab App (Son's English Vocabulary)",
...
SHARED_CONTENT = {
    ...
    "portfolio": [
        {
            "name": "AI콜봇 NoMiss (getnomiss.com)",
            "type_label": "자체 제품",
            "period": "2025.10 ~ 현재",
            "summary": "1인 미용실·출장설비를 위한 30초 AI 음성 응대 및 모바일 접수 카드 솔루션",
            ...
            "result": "작업 중 부재콜 이탈 방지 및 사장님 스마트폰 3줄 요약 알림·원터치 콜백 체계 가동",
            "tech": "FastAPI, WebRTC, WebSocket, 알림톡 API, Next.js",
            "image": "portfolio/thumb/2026-nomiss-thumb-v1.jpg",
            "link": "https://getnomiss.com",
        },
        {
            "name": "광주 도서관 통합검색 (도서관포털)",
            "type_label": "자체 제품",
            "period": "2025.08 ~ 현재",
            "summary": "광주광역시 및 전국 공공도서관 소장 정보 및 실시간 대출 상태 통합 검색 서비스",
            ...
            "result": "분산된 도서관 데이터 단일 통합 및 실시간 소장 상태 일괄 조회 시스템 구축",
            "tech": "Next.js, Django, PostgreSQL, Celery, Redis, pg_trgm",
            "image": "portfolio/thumb/2025-library-portal-thumb-v1.jpg",
            "link": "https://github.com/quroom/library-portal",
        },
        {
            "name": "단어장앱 (아들 영단어 암기장)",
            "type_label": "자체 제품",
            "period": "2025.06 ~ 현재",
            "summary": "SM-2 간격 반복 알고리즘 기반의 오프라인 우선(Offline-First) 크로스플랫폼 단어장",
            ...
            "result": "오프라인 상태에서도 0ms 즉각 반응 학습 및 발음 재생 지연 제거 완료",
            "tech": "Next.js, Capacitor, TypeScript, IndexedDB, Web Audio API",
            "image": "portfolio/thumb/2025-son-vocab-thumb-v1.jpg",
            "link": "https://github.com/quroom/son-english-vocab",
        },
        {
