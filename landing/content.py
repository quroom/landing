...
EN_TRANSLATIONS = {
    ...
    "범위와 우선순위를 먼저 조율하고, 필요한 실행은 직접 맡아 진행합니다.": "We align scope and priorities first, then take on the work that needs to move.",
...
SHARED_CONTENT = {
    ...
    "subcopy": "범위와 우선순위를 먼저 조율하고, 필요한 실행은 직접 맡아 진행합니다.",
