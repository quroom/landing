...
VARIANTS: dict[str, AdLandingVariant] = {
    ...
    "vibe_coding": AdLandingVariant(
        ...
        intent="vibe_sos",
        headline="Codex·Claude로 만든 서비스,\n해결하지 못하면 100% 환불해 드립니다",
        subcopy="배포 실패, Nginx 502, 소셜 로그인 연동, DB 마이그레이션 등 실서버 문제를 8년 차 개발사가 직접 해결합니다. 난이도별 15만~30만 원 확정 정찰제로 진행되며, 문제 미해결 시 100% 전액 환불합니다.",
        primary_cta="기술 진단 신청",
        secondary_cta="해결 사례 및 포트폴리오",
        inquiry_type="vibe_diagnosis",
        eyebrow="미해결 시 100% 전액 환불 보장",
    ),
