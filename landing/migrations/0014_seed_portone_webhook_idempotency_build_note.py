...
최근 Cursor나 Claude 같은 AI 도구를 사용해 결제 기능을 구현하는 창업자와 개발자가 많습니다. 프론트엔드에서 SDK 자바스크립트를 복사해 넣으면 카드 결제창이나 카카오페이 창이 멋지게 뜨고, 결제 완료 알림창까지 완벽하게 동작합니다.
...
def seed_portone_webhook_note(apps, schema_editor):
    ...
    BuildNote.objects.update_or_create(
        ...
        defaults={
            ...
            "summary": (
                "Cursor나 Claude로 결제창을 띄운 뒤 결제 완료 브라우저를 닫았을 때 발생하는 "
